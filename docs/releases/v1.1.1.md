...
Releases now publish it automatically, with npm provenance. `@agentguard/sdk` on npm is unrelated to AgentGuard; if you installed it following our old docs, remove it.
