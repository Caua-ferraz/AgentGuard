...
This first version was published by hand; from the next release, GitHub Actions publishes it through npm trusted publishing, with provenance. `@agentguard/sdk` on npm is unrelated to AgentGuard; if you installed it following our old docs, remove it.
